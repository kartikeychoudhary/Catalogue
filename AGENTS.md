...
## What this is
Three independent Angular 21 starter projects, one per design catalogue
...
- Angular 21.x, NgModule-based (standalone: false everywhere)
...
- catalogue2/  <style 02>      — <one-line identity>
